...
export const zhHant: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        resumeSession: '繼續工作階段',
        resumeSessionSubtitle: '在相同裝置上繼續這個工作階段',
        resumeSessionSameMachineOnly: '這個工作階段只能在原本啟動它的同一台裝置上繼續。',
        resumeSessionMachineOffline: '這台裝置目前離線。只有在線上時才能繼續工作階段。',
        resumeSessionNeedsHappyAgent: '這台裝置目前無法繼續工作階段。請執行 `happy-agent auth login` 來啟用此功能。',
        resumeSessionMissingMachine: '這個工作階段缺少裝置中繼資料，因此無法繼續。',
        resumeSessionMissingBackendId: '這個工作階段沒有可繼續使用的 Claude 或 Codex 識別碼。',
        resumeSessionUnexpectedDirectoryPrompt: '繼續功能無法建立目錄。請回到原本路徑手動啟動這個工作階段。',
